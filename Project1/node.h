...
class Node {
private:
    string name; // Name of node (the name we define the node to be)
...
public:
    ...
    void setName(string name) { this->name = name; }; // Set name of node
    string getName() const { return name; };          // Get name of node
